      ...
      <Tabs defaultValue="stats" className="w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select value={character.race} onValueChange={(value) => setCharacter({ ...character, race: value })} disabled={!isEditing}>
                  <SelectTrigger className="pixel-border bg-card/50 backdrop-blur-sm font-pixel text-xs h-12"><SelectValue placeholder="Selecione..." /></SelectTrigger>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input type="number" value={character.level} onChange={(e) => setCharacter({ ...character, level: parseInt(e.target.value) || 1 })} className="flex h-12 w-full pixel-border bg-card/50 backdrop-blur-sm px-3 py-2 font-pixel text-xs text-center text-foreground" min={1} max={20} disabled={!isEditing} />
          ...
          <PixelCard>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-muted/30 p-4 pixel-border text-center">
                ...
                <input type="number" value={character.initiative} onChange={(e) => setCharacter({ ...character, initiative: parseInt(e.target.value) || 0 })} className="w-full h-12 pixel-border bg-card/50 px-2 font-pixel text-lg text-center text-foreground" disabled={!isEditing} />
              </div>
              <div className="bg-muted/30 p-4 pixel-border text-center">
                <Label className="font-pixel text-xs text-secondary mb-2 block">HP</Label>
                <div className="flex items-center justify-center gap-1">
                  <input type="number" value={character.hp} onChange={(e) => setCharacter({ ...character, hp: parseInt(e.target.value) || 0 })} className="w-16 h-12 pixel-border bg-card/50 px-1 font-pixel text-sm text-center text-destructive" />
        ...
        <TabsContent value="notes" className="mt-6">
          <PixelCard>
            ...
            <textarea className="w-full min-h-[200px] pixel-border bg-card/50 p-4 font-pixel text-xs resize-none" placeholder="Escreva suas anotações sobre o personagem..." />
          </PixelCard>
        </TabsContent>
      </Tabs>
    </div>
